export const CATEGORY_COLORS: { [key: string]: string } = {
  ...
  "🛍️ Shopping": "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400 border-yellow-200 dark:border-yellow-800",
  "🍻 Drinks & Nightlife": "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400 border-purple-200 dark:border-purple-800",
...
export const CATEGORY_STRIP_COLORS: { [key: string]: string } = {
  ...
  "🛍️ Shopping": "bg-yellow-500",
  "🍻 Drinks & Nightlife": "bg-purple-500",
  "📝 General / Other": "bg-gray-300",
};
